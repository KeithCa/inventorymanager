...
{
	private static String base_URL = "http://192.168.1.9:80/";		//Default configuration for WAMP - 80 is default port for WAMP and 10.0.2.2 is localhost IP in Android Emulator
